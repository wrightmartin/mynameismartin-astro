...
There's a less obvious consequence too. Every visit to a lighter site transfers less data. Multiply that across every visitor, every page, every month, and the difference in energy and bandwidth adds up. 

Leaving Squarespace moved me from a C rating on Website Carbon's audit tool, to an [A+](https://www.websitecarbon.com/website/mynameismartin-co-uk/). A smaller site is a more responsible one. 

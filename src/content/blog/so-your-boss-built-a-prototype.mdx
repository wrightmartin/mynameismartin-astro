...
When a senior person builds something and shows it to the team, it carries weight. It doesn't matter if it's right or not. The prototype sets the context and the team's job shifts from solving the problem to responding to the artefact.
